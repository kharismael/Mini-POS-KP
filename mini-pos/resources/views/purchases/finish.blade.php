    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLongTitle">Konfirmasi Selesai Pembelian</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <form action="#" id="finish-purchases-form" method="post">
          ...
          <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-dark" value="delete">Finish Pembelian</button>
          </div>
      </form>
      </div>
    </div>
